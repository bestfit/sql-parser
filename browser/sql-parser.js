...
(function() {
  ...
  Lexer = (function() {
    ...
    Lexer.prototype.keywordToken = function() {
      return this.tokenizeFromWord('SELECT') || this.tokenizeFromWord('INSERT') || this.tokenizeFromWord('INTO') || this.tokenizeFromWord('WITH') || this.tokenizeFromWord('VALUE') || this.tokenizeFromWord('DISTINCT') || this.tokenizeFromWord('FROM') || this.tokenizeFromWord('WHERE') || this.tokenizeFromWord('GROUP') || this.tokenizeFromWord('ORDER') || this.tokenizeFromWord('BY') || this.tokenizeFromWord('HAVING') || this.tokenizeFromWord('LIMIT') || this.tokenizeFromWord('JOIN') || this.tokenizeFromWord('LEFT') || this.tokenizeFromWord('RIGHT') || this.tokenizeFromWord('INNER') || this.tokenizeFromWord('OUTER') || this.tokenizeFromWord('ON') || this.tokenizeFromWord('AS') || this.tokenizeFromWord('UNION') || this.tokenizeFromWord('ALL') || this.tokenizeFromWord('LIMIT') || this.tokenizeFromWord('OFFSET') || this.tokenizeFromWord('FETCH') || this.tokenizeFromWord('ROW') || this.tokenizeFromWord('ROWS') || this.tokenizeFromWord('ONLY') || this.tokenizeFromWord('NEXT') || this.tokenizeFromWord('FIRST');
    };
    ...
    while (true) {
        ...
        if (this.defaultActions[state]) {
            ...
            if (typeof action === 'undefined' || !action.length || !action[0]) {
                ...
                for (var index = 0; index < lexer.pos - 1; index++) {
                  position += lexer.tokens[index][1].length;
                }

                if (lexer.showPosition) {
                    errStr = 'Parse error on line ' + (yylineno + 1) + ':\n' + lexer.showPosition() + '\nExpecting ' + expected.join(', ') + ', got \'' + (this.terminals_[symbol] || symbol) + '\'';
                } else {
                    errStr = '1 error was found during analysis. An expression was expected. (near "' + lexer.yytext + '" at position ' + (position + 1) + ')';
                }
...
if (typeof module !== 'undefined' && require.main === module) {
  ...
  // Generated by CoffeeScript 1.8.0
(function() {
  var Alias, ArgumentListValue, BetweenOp, Field, FunctionValue, Group, Having, Insert, Join, Limit, ListValue, LiteralValue, Offset, Op, Order, OrderArgument, ParameterValue, Select, Star, StringValue, SubSelect, Table, UnaryOp, Union, Where, With, indent;
  ...
  exports.Alias = Alias = (function() {
    function Alias(name, subSelect) {
      this.name = name;
  ...
  exports.Insert = Insert = (function() {
    ...
    Insert.prototype.toString = function() {
      var ret;
      return ret = "INSERT INTO " + this.source + "\n " + (this.fields.join(', ')) + " VALUE " + (this.values.join(', '));
    };
