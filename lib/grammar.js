...
(function() {
  ...
  grammar = {
    ...
    InsertQuery: [o('Insert'), o('InsertClause')],
    InsertClause: [
      o('INSERT INTO Table LEFT_PAREN Fields RIGHT_PAREN VALUE LEFT_PAREN Values RIGHT_PAREN', function() {
        return new Insert($3, $5, $9);
      })
    ],
    Values: [
      o('Value', function() {
        return [$1];
      }), o('Values SEPARATOR Value', function() {
        return $1.concat($3);
      })
    ],
    WithQuery: [
      o('With'), o('WithClause'), o('WithClause SelectClause', function() {
        $1.select = $2;
        return $1;
      })
    ],
    WithClause: [
      o('WITH Aliases', function() {
        return new With($2);
      })
    ],
    Aliases: [
      o('Alias', function() {
        return [$1];
      }), o('Aliases SEPARATOR Alias', function() {
        return $1.concat($3);
      })
    ],
    Alias: [
      o('Literal AS LEFT_PAREN Query RIGHT_PAREN', function() {
        return new Alias($1, $4);
      })
    ],
    SelectClause: [
